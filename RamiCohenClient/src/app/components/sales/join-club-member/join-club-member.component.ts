...
@Component({
  selector: 'app-join-club-member',
  templateUrl: './join-club-member.component.html',
  styleUrls: ['./join-club-member.component.css']
})
export class JoinClubMemberComponent implements OnInit {
